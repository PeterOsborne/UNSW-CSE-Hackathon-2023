                ...
                <div className="flex flex-col p-3">
                    <div className="flex justify-end">
                        <div className="grid grid-cols-3">
                            <div className='p-2'>
                                <div className='bg-white rounded-lg shadow-md flex flex-col justify-center items-center p-1'>
                                    ...
                                    <Link to="/login" className='flex font-medium size-md text-l'>
                            ...
                            <div className='p-2'>
                                <div className='bg-white rounded-lg shadow-md flex flex-col justify-center items-center p-1' onClick={handleClick}>
                                    ...
                                    <div className="flex font-medium size-md text-l pr-1 pl-1">Satellite View {isToggled ? 'ON' : 'OFF'}</div>
                                </div>
                            </div>
